...
2. **Arena** — click platform center and edge, click one hole, generate the other 19 at 18°, nudge if needed, choose the target, enter platform diameter in cm. Reuse that layout on later videos.
...
- **Align-to-video registration can undershoot** if it treats a bright hotspot or wall as the maze. Reuse a previous layout, then nudge the platform and hole ring if the overlay is off.
