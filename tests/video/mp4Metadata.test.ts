...
describe("mp4 metadata", () => {
  it("reads a 15000/1001 timebase from stts + mdhd", () => {
    const mdhd = box(
      "mdhd",
      concat(new Uint8Array(4), u32(0), u32(0), u32(15000), u32(15000)),
    );
    const stts = box("stts", concat(u32(0), u32(1), u32(100), u32(1001)));
